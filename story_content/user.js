...
// ==============================
// MOBILE SCROLL SMOOTH FIX
// ==============================
if (!document.getElementById("mobile-scroll-fix")) {
  var fixScroll = document.createElement("style");
  fixScroll.id = "mobile-scroll-fix";
  fixScroll.innerHTML = `
    [data-acc-text="RecommendedLinks"] div {
      -webkit-overflow-scrolling: touch;
    }
  `;
  document.head.appendChild(fixScroll);
}
...
// PAYMENT TEXT (unchanged except bold-ready if needed)
emailText +=
