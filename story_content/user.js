...
emailText +=
  "Please pay the course fees *Rs. 999* on the following link and share your payment confirmation screenshot to start taking the courses.\n" +
...
if (isMobile) {
  ...
  emailLink =
    "https://mail.google.com/mail/?view=cm&fs=1" +
    "&to=" + encodeURIComponent(USER_EMAIL || "") +
    "&su=" + encodeURIComponent("Your Personalized Learning Plan – greytHR Academy") +
    "&body=" + encodeURIComponent(emailText);
}
