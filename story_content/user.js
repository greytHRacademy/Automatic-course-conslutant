...
{
  var player = GetPlayer();
var mobile = player.GetVar("UserMobile");
...
if (/^[0-9]{10}$/.test(mobile)) {
    player.SetVar("MobileValid", true);
} else {
    player.SetVar("MobileValid", false);
}
}
...
var USER_MOBILE = player.GetVar("UserMobile") || "";
...
var emailText =
  ...
  "As per the answers you gave, here is the recommended learning path for you. Please click each link to take the respective course.\n\n" +
  "Course links:\n";
...
// ==============================
// ALWAYS SHOW AI COURSE AS #1
// ==============================
html +=
  "<div style='margin-bottom:12px;font-family:Poppins,Arial,sans-serif;'>" +
    "<span style='font-weight:700;margin-right:6px;'>1.</span>" +
    "<a href='https://training.greythr.com/course/view.php?id=361' target='_blank' style='color:#0066cc;text-decoration:underline;font-weight:600;'>" +
      "Using Artificial Intelligence - An Introduction" +
    "</a>" +
  "</div>";

emailText +=
  "1. Using Artificial Intelligence - An Introduction\n" +
  "https://training.greythr.com/course/view.php?id=361\n\n";

count = 2;

// ==============================
// RECOMMENDED COURSE LINKS
// ==============================
...
// ==============================
// APPLY FOR MASTER CERTIFICATE
// ==============================
html +=
  "<div style='margin-top:16px;font-family:Poppins,Arial,sans-serif;'>" +
    "<span style='font-weight:700;margin-right:6px;'>" + count + ".</span>" +
    "<a href='https://docs.google.com/forms/d/e/1FAIpQLScNDUOvWdArmN0L7MxmFa6qnzoVNSzWTseexIdFm6-6SZAKrA/viewform?usp=publish-editor' target='_blank' style='color:#0066cc;text-decoration:underline;font-weight:600;'>" +
      "Apply for master certificate" +
    "</a>" +
  "</div>";

emailText +=
  "Please log your queries on the following link to get them resolved from the experts in one day.\n" +
  "https://docs.google.com/forms/d/e/1FAIpQLSeipKpRydPXDuE3-cOHPZDa50LCKJoCwP5fQv5QHMWEfyWLBw/viewform\n\n";

emailText +=
  "Also, please apply for the master certificate on the following link and share the certificate on your social media handle to let the employers know about your new achievement.\n" +
  "https://docs.google.com/forms/d/e/1FAIpQLScNDUOvWdArmN0L7MxmFa6qnzoVNSzWTseexIdFm6-6SZAKrA/viewform?usp=publish-editor\n\n";

emailText +=
  "We wish you all the best to complete the course quickly and are always standing with you to resolve any queries that you come across.\n\n";
...
document.addEventListener("visibilitychange", function () {
  ...
  if (document.hidden) {
    // User left the page
    player.SetVar("PauseAudio", true);
  } else {
    // User returned to the page
    player.SetVar("PauseAudio", false);
  }
...
// ==============================
links.push({
  text:"Using Artificial Intelligence - An Introduction",
  url:"https://training.greythr.com/course/view.php?id=361"
});
...
// ==============================
links.push({
  text:"Apply for master certificate",
  url:"https://docs.google.com/forms/d/e/1FAIpQLScNDUOvWdArmN0L7MxmFa6qnzoVNSzWTseexIdFm6-6SZAKrA/viewform?usp=publish-editor"
});
...
if (isMobile) {
  ...
  emailLink =
    ...
    "?cc=" + encodeURIComponent(EMAIL_CC || "") +
    "&subject=" + encodeURIComponent("Your Personalized Learning Plan – greytHR Academy") +
    "&body=" + encodeURIComponent(emailText);
}
...
// Q&A LINK
// ==============================
var qaUrl = "https://docs.google.com/forms/d/e/1FAIpQLSeipKpRydPXDuE3-cOHPZDa50LCKJoCwP5fQv5QHMWEfyWLBw/viewform";
